  ...
  return (
    <main className="engineer-workspace min-h-screen px-4 py-16">
      <section className="mx-auto w-full max-w-3xl border border-[var(--engineer-border)] bg-[var(--engineer-paper-strong)] p-8 sm:p-12">
        <p className="mb-3 text-[10px] font-bold tracking-widest uppercase text-[var(--engineer-accent)]">Error 404</p>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link to="/" className="engineer-action-button is-primary rounded px-4 py-2 text-[10px]">
            Back to home
          </Link>
          <Link
            to="/admin/posts/new"
